/**
 * How close two points come before this package reads them as the same place.
 *
 * It is a distance in the picture's own units rather than a share of anything,
 * so a figure drawn in units of thousands needs its own number passed in. Every
 ...
 * pixels to the unit the demos draw at, so nothing this number sets is visible. What
 * it sets is which meetings are told apart, since two crossings closer than
 * this are returned as one.
 */
