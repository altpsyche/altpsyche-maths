...
| `demos/rotate.figure.json` | 22,789 | a rotation about a box's middle and about a named place, a swell, a walk into another shape, a wave and a rock, and a loop |
