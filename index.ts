...
export { applyMatrix, circumscribe, countTo, fadeIn, fadeOut, fadeTo, draw, flash, growFrom, indicate, morph, morphEquation, moveAlong, moveBy, rotate, scale, showPassingFlash } from './figure/animation.js';
export type { AboutOptions, Animation, CircumscribeOptions, FlashOptions, IndicateOptions, PassingFlashOptions, ScaleOptions } from './figure/animation.js';
