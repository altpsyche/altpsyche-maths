...
export { fadeIn, fadeOut, fadeTo, draw, growFrom, indicate, morph, moveAlong, moveBy, rotate, scale } from './figure/animation.js';
export type { AboutOptions, Animation, IndicateOptions, ScaleOptions } from './figure/animation.js';
