...
export { applyMatrix, circumscribe, countTo, fadeIn, fadeOut, fadeTo, draw, flash, growFrom, indicate, morph, morphEquation, moveAlong, moveBy, rotate, scale, showPassingFlash, wave } from './figure/animation.js';
export type { AboutOptions, Animation, CircumscribeOptions, FlashOptions, IndicateOptions, PassingFlashOptions, ScaleOptions, WaveOptions } from './figure/animation.js';
